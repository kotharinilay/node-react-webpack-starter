...
/****************************************************
 * Main component to wrap all draggable components
 * responsible to bind props, layout adjustments etc
 * ************************************************/

import React from 'react';
import { debounce, sortBy } from 'lodash';
import BaseStyleObject from './BaseDisplayObject.js';
...
export default class AbsoluteGrid extends React.Component {
  ...
  constructor(props, context) {
    ...
    this.dragManager = new DragManager(this.props.onMove, this.props.keyProp, this.props.onDragEnd);
    this.mounted = false;
    this.state = {
      layoutWidth: 0,
      dragItemId: 0
  ...
  getDOMWidth = () => {
    ...
    if (this.state.layoutWidth !== width && this.mounted) {
