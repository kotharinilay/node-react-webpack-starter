...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        lambda_deploy: {
            default: {
                arn: 'arn:aws:lambda:ap-southeast-2:027433987909:function:validate-import-tags',
                options: {
    ...
    grunt.registerTask('run', ['webpack', 'copy:lambda', 'webpack', 'lambda_invoke', 'clean:lambda']);
