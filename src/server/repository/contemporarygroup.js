 ...
 * 'contemporarygroup' table
 * *************************************/

import models from '../schema';

// get all contemporarygroup for drop down
let getBindings = (language, companyId, regionId, businessId, propertyId) => {
    companyId = companyId || '';
    regionId = regionId || '';
    businessId = businessId || '';
    propertyId = propertyId || '';
    let query = `CALL sp_contemporarygroup_ddl('${propertyId}','${companyId}','${regionId}','${businessId}','${language}');`;
...
module.exports = {
    getContemporaryGroupBindings: getBindings
}