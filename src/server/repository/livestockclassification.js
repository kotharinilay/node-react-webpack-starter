 ...
 * 'livestockclassification' table
 * *************************************/

import models from '../schema';

// get all livestockclassification for drop down
let getBindings = (language, companyId, regionId, businessId, propertyId) => {
    companyId = companyId || '';
    regionId = regionId || '';
    businessId = businessId || '';
    propertyId = propertyId || '';
    let query = `CALL sp_livestockclassification_ddl('${propertyId}','${companyId}','${regionId}','${businessId}','${language}');`;
...
module.exports = {
    getLivestockClassificationBindings: getBindings
}