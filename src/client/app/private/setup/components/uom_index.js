...
/**************************
 * Index page for setup unit of measure
 * **************************** */

import React, { Component } from 'react';
import UomDetail from './uom_detail';
import UomDisplay from './uom_display';
...
class Uom extends Component {
    ...
    render() {
        ...
        if (this.props.params && this.props.params.detail) {
            ...
            component = <UomDetail detail={this.props.params.detail}
            ...
            component = <UomDisplay notifyToaster={this.props.notifyToaster}
...
export default Decorator('Uom',Uom);