...
import { saveGroup as saveGroupDetail, getGroupModifyDetails } from '../../../../services/private/setup';
...
class GroupDetail extends Component {
    constructor(props) {
        ...
        this.groupData = null;
        this.groupSchema = ['groupName', 'groupCode'];
    ...
    componentWillMount() {
        ...
        if (this.addMode) {
            ...
            return getGroupModifyDetails(this.props.detail).then(function (res) {
                if (res.success) {
    ...
    handleAddEdit(obj) {
        let _this = this;
        return saveGroupDetail(obj).then(function (res) {
            if (res.success) {
                if (_this.addMode) {
    ...
    saveGroup(e) {
        e.preventDefault();
        let isFormValid = isValidForm(this.groupSchema, this.refs);
        if (!isFormValid) {
        ...
        let obj = getForm(this.groupSchema, this.refs);
        obj.configuredByAdmin = 1;
        if (!this.addMode) {
            obj.groupId = this.props.detail;
            obj.auditId = this.groupData.AuditLogId;
        }
    ...
    onBack() {
        browserHistory.replace('/adminsetup/group');
    }
                ...
                <div className="stock-list">
                    <div className="stock-list-cover">
                        <div className="livestock-content">
                            ...
                            <form autoComplete="off" className="form-cover" onSubmit={this.saveGroup}>
                                    ...
                                    <div className="form-group is-password">
                                        <div className="col-md-12">
                                            <Input inputProps={{
                                                ...
                                                maxLength={10} initialValue={this.groupData ? this.groupData.SystemCode : ''}
                                ...
                                <div className="form-group is-password">
                                    <div className="col-md-12">
                                        <Input inputProps={{
                                            name: 'groupCode',
                                            hintText: this.strings.CONTROLS.GROUP_CODE_PLACEHOLDER,
                                            floatingLabelText: this.strings.CONTROLS.GROUP_CODE_LABEL
                                        }}
                                            maxLength={10} initialValue={this.groupData ? this.groupData.GroupCode : null}
                                            eReq={this.strings.CONTROLS.GROUP_CODE_REQ_MESSAGE}
                                            isClicked={this.state.isClicked} ref="groupCode" />
                                    </div>
                                </div>
                                <div className="form-group is-password">
                                    <div className="col-md-12">
                                        <Input inputProps={{
                                            name: 'groupName',
                                            hintText: this.strings.CONTROLS.GROUP_PLACEHOLDER,
                                            floatingLabelText: this.strings.CONTROLS.GROUP_LABEL
                                        }}
                                            maxLength={50} initialValue={this.groupData ? this.groupData.GroupName : ''}
                                            eReq={this.strings.CONTROLS.GROUP_REQ_MESSAGE}
                                            isClicked={this.state.isClicked} ref="groupName" />
                                    </div>
                                </div>
                    ...
                    <div className="live-detail-main">
                        ...
                        <div className="l-stock-top-btn setup-top">
                            ...
                            <BusyButton
                                ...
                                loaderHeight={25}
                                redirectUrl={!this.addMode ? '/adminsetup/group' : null}
                                onClick={this.saveGroup} ></BusyButton>
                        </div>
                    </div>
                </div>
                {this.renderForm()}
