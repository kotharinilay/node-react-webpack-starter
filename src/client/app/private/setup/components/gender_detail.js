...
import { saveGender as saveGenderDetail, getGenderModifyDetails } from '../../../../services/private/setup';
...
class GenderDetail extends Component {
    constructor(props) {
        ...
        this.genderSchema = ['genderName', 'genderCode'];
    ...
    componentWillMount() {
        ...
        if (this.addMode) {
            ...
            return getGenderModifyDetails(this.props.detail).then(function (res) {
                if (res.success) {
    ...
    handleAddEdit(obj) {
        let _this = this;
        return saveGenderDetail(obj).then(function (res) {
            if (res.success) {
                if (_this.addMode) {
    ...
    saveGender(e) {
        e.preventDefault();
        let isFormValid = isValidForm(this.genderSchema, this.refs);
        if (!isFormValid) {
        ...
        let obj = getForm(this.genderSchema, this.refs);
        if (!this.addMode) {
            obj.genderId = this.props.detail;
            obj.auditId = this.genderData.AuditLogId;
        }
    ...
    onBack() {
        browserHistory.replace('/adminsetup/gender');
    }
                ...
                <div className="stock-list">
                    <div className="stock-list-cover">
                        <div className="livestock-content">
                            ...
                            <form autoComplete="off" className="form-cover" onSubmit={this.saveGender}>
                                    ...
                                    <div className="form-group is-password">
                                        <div className="col-md-12">
                                            <Input inputProps={{
                                                ...
                                                maxLength={10} initialValue={this.genderData ? this.genderData.SystemCode : ''}
                                ...
                                <div className="form-group is-password">
                                    <div className="col-md-12">
                                        <Input inputProps={{
                                            name: 'genderCode',
                                            hintText: this.strings.CONTROLS.GENDER_CODE_PLACEHOLDER,
                                            floatingLabelText: this.strings.CONTROLS.GENDER_CODE_LABEL
                                        }}
                                            maxLength={10} initialValue={this.genderData ? this.genderData.GenderCode : ''}
                                            eReq={this.strings.CONTROLS.GENDER_CODE_REQ_MESSAGE}
                                            isClicked={this.state.isClicked} ref="genderCode" />
                                    </div>
                                </div>
                                <div className="form-group is-password">
                                    <div className="col-md-12">
                                        <Input inputProps={{
                                            name: 'genderName',
                                            hintText: this.strings.CONTROLS.GENDER_PLACEHOLDER,
                                            floatingLabelText: this.strings.CONTROLS.GENDER_LABEL
                                        }}
                                            maxLength={50} initialValue={this.genderData ? this.genderData.GenderName : ''}
                                            eReq={this.strings.CONTROLS.GENDER_REQ_MESSAGE}
                                            isClicked={this.state.isClicked} ref="genderName" />
                                    </div>
                                </div>
                    ...
                    <div className="live-detail-main">
                        ...
                        <div className="l-stock-top-btn setup-top">
                            ...
                            <BusyButton
                                ...
                                loaderHeight={25}
                                redirectUrl={!this.addMode ? '/adminsetup/gender' : null}
                                onClick={this.saveGender} ></BusyButton>
                        </div>
                    </div>
                </div>
                {this.renderForm()}
