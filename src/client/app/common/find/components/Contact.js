 ...
 * Find Contact from Aglive database. 
 ******************************************/
...
import { findContact } from '../../../../services/private/find';
...
class FindContact extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            grid: {
                columns: [
                    ...
                    { field: 'ContactName', displayName: GRID_COLUMNS.CONTACT_NAME, isKey: false, visible: true },
                    { field: 'CompanyName', displayName: GRID_COLUMNS.COMPANY_NAME, isKey: false, visible: true },
        ...
        this.findContactSchema = ['contactName', 'companyName', 'businessName', 'abn', 'acn'];
    ...
    hideModal(payload) {
        if (payload == undefined)
            payload = null;
        this.props.hideFindContact({ TargetKey: this.props.TargetKey, Payload: payload });
    }
    ...
    search(e) {
        ...
        let _this = this;
        let isFormValid = isValidForm(this.findContactSchema, this.refs);
        let obj = getForm(this.findContactSchema, this.refs);
        let suburb = this.refs.businessSuburb.state;

        if (obj.companyName == null && obj.businessName == null && obj.contactName == null && obj.abn == null && obj.acn == null && (suburb == null || suburb.suburbId == null)) {
        ...
        findContact(obj).then(function (res) {
            if (res.success) {
                ...
                _this.setState({ grid: { gridData: res.data } });
            }
            else {
            ...
            <Modal isOpen={this.props.isOpen} keyboard={false} size="modal-lg">
                ...
                <ModalBody>
                    <form autoComplete="off" className="form-cover" onSubmit={this.search}>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <Input inputProps={{
                                        ...
                                        disabled: this.props.companyName ? true : false
                                    }}
                                        initialValue={this.props.companyName || ''}
                                        maxLength={250} isClicked={this.state.isClicked} ref="companyName" />
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6">
                        ...
                        <Grid ref="findContactGrid" isRemoteData={false} selectRowMode={null} {...this.state.grid} selectClick={this.selectClick} />
                    </form>
                </ModalBody>
                <ModalFooter>
