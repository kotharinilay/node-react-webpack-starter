...
module.exports = {
    DISPLAY: {
        ...
        HELP_LABEL: "Help",
        DESCRIPTION: 'Manage Accreditation Program that will be available to all users',
    ...
    DETAIL: {
        ...
        DESCRIPTION: 'Update Accreditation Program details',
        HELP_LABEL: "Help",
        ADD_SUCCESS: 'Accreditation Program added successfully.',
        MODIFY_SUCCESS: 'Accreditation Program modified successfully.',
        VALIDATION: {
            1074: "Please enter Program Name",
            1075: "Please enter Program Code",
            1076: "Program Name should not exceed 50 characters.",
            1077: "Program Code should not exceed 10 characters."
        }
    }
};