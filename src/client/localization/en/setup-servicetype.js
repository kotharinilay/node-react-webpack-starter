...
module.exports = {
    DISPLAY: {
        ...
        HELP_LABEL: "Help",
        DESCRIPTION: 'Manage Service Type that will be available to all users',
    ...
    DETAIL: {
        ...
        HELP_LABEL: "Help",
        DESCRIPTION: 'Update Service Type Program details',
        ADD_SUCCESS: 'Service Type saved successfully.',
