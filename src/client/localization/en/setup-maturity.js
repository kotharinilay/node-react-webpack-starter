...
module.exports = {
    DISPLAY: {
        ...
        HELP_LABEL: "Help",
        DESCRIPTION: 'Manage Maturity that will be available to all users',
        DELETE_SUCCESS: 'Maturity(s) deleted successfully.',
        DELETE_CONFIRMATION_MESSAGE: "Are you sure you want to delete?"
    },
    DETAIL: {
        ADD_TITLE: "ADD MATURITY",
        MODIFY_TITLE: "MODIFY MATURITY",
        CONTROLS: {
            SAVE_LABEL: "SAVE",
            BACK_LABEL: "CANCEL",
            HEADER_TEXT: "Some Text",
            MATURITY_LABEL: "Maturity Name",
        ...
        HELP_LABEL: "Help",
        DESCRIPTION: 'Update Maturity Program details',
        ADD_SUCCESS: 'Maturity saved successfully.',
