...
module.exports = {
    DISPLAY: {
        ...
        HELP_LABEL: "Help",
        DESCRIPTION: 'Manage Species that will be available to all users',
    ...
    DETAIL: {
        ...
        HELP_LABEL: "Help",
        DESCRIPTION: 'Update Species Program details',
        ADD_SUCCESS: 'Species added successfully.',
        MODIFY_SUCCESS: 'Species modified successfully.',
