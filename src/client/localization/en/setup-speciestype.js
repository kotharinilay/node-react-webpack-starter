...
module.exports = {
    DISPLAY: {
        ...
        HELP_LABEL: "Help",
        DESCRIPTION: 'Manage Species Type that will be available to all users',
        DELETE_SUCCESS: 'Species Type(s) deleted successfully.',
        DELETE_CONFIRMATION_MESSAGE: "Are you sure you want to delete?"
    },
    DETAIL: {
        ADD_TITLE: "ADD SPECIES TYPE",
        MODIFY_TITLE: "MODIFY SPECIES TYPE",
        CONTROLS: {
            SAVE_LABEL: "SAVE",
            BACK_LABEL: "CANCEL",
        ...
        HELP_LABEL: "Help",
        DESCRIPTION: 'Update Species Type Program details',
