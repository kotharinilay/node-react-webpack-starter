...
module.exports = {
    DISPLAY: {
        ...
        SET_PASSWORD: {
            ...
            TITLE: "SET PASSWORD",
            CONTROLS: {
                LOGGEDIN_PASSWORD_LABEL: "Loggedin password",
                LOGGEDIN_PASSWORD_PLACE_HOLDER: "Enter Loggedin password",
                LOGGEDIN_PASSWORD_REQ_MESSAGE: "Please enter Loggedin password",
    ...
    DETAIL: {
        ...
        CONTROLS: {
            ...
            CONTACT_SUBURB_PLACEHOLDER: "Enter Business Suburb",
            CONTACT_SUBURB_LABEL: "Business Suburb",
            CONTACT_POSTALSUBURB_PLACEHOLDER: "Enter Postal Suburb",
            CONTACT_POSTALSUBURB_LABEL: "Postal Suburb",
            CONTACT_STATE_PLACEHOLDER: "Enter Business State",
            CONTACT_STATE_LABEL: "Business State",
            CONTACT_POSTALSTATE_PLACEHOLDER: "Enter Postal State",
            CONTACT_POSTALSTATE_LABEL: "Postal State",
            CONTACT_POSTCODE_PLACEHOLDER: "Enter Business Post Code",
            CONTACT_POSTCODE_LABEL: "Business Post Code",
            CONTACT_POSTALPOSTCODE_PLACEHOLDER: "Enter Postal Post Code",
            CONTACT_POSTALPOSTCODE_LABEL: "Postal Post Code",
